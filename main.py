...
class Checkers:
    ...
    def play(self):
        ...
        print("4.You should add coordinates seamlessly. For example: (4,3)")
        print("5.Firstly input y coordinate, later - x")

        print("Add your name:")
        playerName = input()
        if playerName == "Nikita Baksheev":
            print(ansi_green + "Computer has cornered itself.\nYOU WIN!" + ansi_reset)
        print("It is owner, I lost already!")
        print("")
        print("")
        print("")
        print("")
        print("Its rofl, let's go play!")
